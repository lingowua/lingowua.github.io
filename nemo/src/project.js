clickChangeFruit.__require = function e(t, n, o) {
    function c(i, r) {
        if (!n[i]) {
            if (!t[i]) {
                var s = i.split("/");
            ...
            h = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    if(gameFunction.default.Instance.targetFruit) {
                      curFruit = ++curFruit % 10;
                      gameFunction.default.Instance.targetFruit.destroy();
                      gameFunction.default.Instance.targetFruit = null;
                      gameFunction.default.Instance.createOneFruit(curFruit); // Math.floor(Math.random()*10)
                    }
                    return;
            ...
            m = function(e) {
                ...
                return o(t, e), t.prototype.onLoad = function() {}, t.prototype.start = function() {
                    ...
                    if (this.node.x < -this.bianjieX && (this.node.x = -this.bianjieX), this.node.x > this.bianjieX && (this.node.x = this.bianjieX), this.notTargetTime += e, this.returnNumber && (this.scheduleOnce(function() {
                            t.getNumberTime = 0
                        }, .25), this.returnNumber = !1), "fruitNode" == this.node.parent.name && (this.testEndDJS += e), this.node.y + this.node.width / 2 > cc.find("Canvas/lineNode").children[0].y && 0 == this.pengzhuangCount 
                      && this.endCtrl && 0 == this.endOne && this.testEndDJS > 3 && wuDi) { // 无敌模式
